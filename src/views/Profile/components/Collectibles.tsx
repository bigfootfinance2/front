  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'BigFoot Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          'BigFoot Collectibles are special ERC-721 NFTs that can be used on the BigFoot Finance platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved BigFoot Collectibles won't be shown here.",
        )}
      </Text>
