...
const ListedOn = () => {
  return (
    <StyledListedOn>
      <CardBody>
        <LinkListed>
          <a href="https://www.dapp.com/app/bigfoot-defi-finance" target="_blank" rel="noreferrer">
            <Image
        ...
        <LinkListed>
          <a href="https://dappradar.com/binance-smart-chain/defi/bigfoot-defi" target="_blank" rel="noreferrer">
            <Image
