    ...
    <>
      <Header>
        ...
        <Heading size="md" color="text">
          <ul>
            <li>{TranslateString(580, 'Stake FOOT to earn new tokens.')}</li>
        ...
        <Text style={{ marginTop: '10px' }}>
          <AddressLink href="https://bigfootfinance.medium.com/the-bush-next-evolution-d9e316be71f1" color="text" external>
