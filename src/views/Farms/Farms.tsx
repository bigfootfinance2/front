  ...
  const farmsList = useCallback(
    (farmsToDisplay): FarmWithStakedValue[] => {
      ...
      let farmsToDisplayWithAPY: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        //   return farm
        // }
        const cakeRewardPerBlock = new BigNumber(farm.bigfootPerBlock || 1)
    ...
    <>
      <Header>
        <Heading as="h1" size="xxl" color="secondary" mb="24px">
          {tokenMode
            ? TranslateString(10002, 'Stake tokens to earn FOOT')
            : TranslateString(320, 'Stake LP tokens to earn FOOT')}
        </Heading>
        <Heading size="lg" color="text">
          {TranslateString(10000, 'Deposit Fee will be used to buyback FOOT')}
        </Heading>
        {/* <Text>
          <AddressLink
            href="https://doc.bigfootfinance.io/tokennomics/burn-mechanism-and-fee-farming"
            color="text"
            external
          >
      ...
      <Page>
        ...
        {renderContent()}
        <Image src="/images/bigfoot/8.png" alt="illustration" width={1352} height={587} responsive />
      </Page>
    </>
  )
}
