...
const fetchFarms = async () => {
  const data = await Promise.all(
    farmsConfig.map(async (farmConfig) => {
      ...
      const [info, totalAllocPoint, poolInfo, bigfootPerBlock] = await multicall(masterchefABI, [
        {
      ...
      return {
        ...
        bigfootPerBlock: new BigNumber(bigfootPerBlock).toNumber(),
